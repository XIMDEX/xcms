...
function usage() {
    echo "Usage: $0 [-h] [-d] [-i] [-a config_file] [-n ximdex_instance_name] [-t web_server_root_path] [-b branch]"
...
function PrintInstructions() {
	...
	echo "    located at $LOCALPATH (run only this step with -d option)"
	echo ""
	...
	echo ""
	echo "This last step may require superuser privileges. A bash script (named $SCRIPT1) will be generated to be run as root if you want to control it."
	echo ""
}
...
if [  $DO_DOWNLOAD -ne 0 ]; then
	...
	echo -e "Downloading optionally skipped."
fi
