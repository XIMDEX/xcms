    ...
    {if $languageCount neq 0}
        ...
        {foreach from=$languageOptions item=languageOption}
            <div class="languages-section">
                <input name="langidlst[]" type='checkbox' value="{$languageOption.IdLanguage}" class="hidden-focus" id="{$languageOption.IdLanguage}_{$nodeID}">
                <label for="{$languageOption.IdLanguage}_{$nodeID}" class="icon checkbox-label">{$languageOption.Name|gettext}</label>
