...
<input type="hidden" name="nodeid" id='nodeid' value="{$nodeid}"><br>
<fieldset>
		<legend><span>{t}Add language{/t}</span></legend>
	<ol>
...
<fieldset class="buttons-form">
			...
			{button label="Create" class='validate'}<!--message="Do you want to create the language?"-->
