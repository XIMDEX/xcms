...
<form method="post" name="ca_form" id="ca_form" action="{$action_url}">
	<input type="hidden" name="nodeid" value="{$id_node}">
		<fieldset>
			<legend><span>{t}Select search criteria{/t}</span></legend>
			<ol>
				<li>
        ...
        <fieldset class="buttons-form">
			...
			{button label="Search" class="validate" }<!--message="A search will be performed with selected parameters. Would you like to continue?"-->
		</fieldset>
</form>
