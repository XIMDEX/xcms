...
<form method="post" id="groups_form" action="{$action_url}">
	<input type="hidden" name="id_node" value="{$id_node}">
        <fieldset>
		<legend><span>{t}Add group to section{/t}</span></legend>
	{if (!$new_groups)}
	...
	<fieldset class="buttons-form">
		{button label="Add group" onclick="call_submit('addgroupnode');" class="validate" }<!--message="Are you sure you want to perform this association?"-->
	</fieldset>
	{/if}
					
        <fieldset>
        	<legend><span>{t}Delete group of a section{/t}</span></legend>
        {if (!$all_groups)}
	...
	{/if}
       ...
       {if ($all_groups)}
	<fieldset class="buttons-form">
		{button label="Delete subscriptions" class="validate" onclick="call_submit('deletegroupnode')" message="Are you sure you want to delete selected subscriptions?"}
		{button class="validate" label="Save changes" onclick="call_submit('updategroupnode');"  message="Are you sure you want to update selected subscriptions?" }
	</fieldset>
	{/if}
</form>
