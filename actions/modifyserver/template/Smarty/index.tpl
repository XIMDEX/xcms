...
<h2>{t}Error messages{/t}</h2>
	<fieldset class="buttons-form">
		...
		{else}
			{button id="create_server" label="Create" class="validate btn main_action"}<!--message="Would you like to create this server?"-->
		{/if}
	</fieldset>
</div>
