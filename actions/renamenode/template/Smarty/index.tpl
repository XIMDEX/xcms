...
<form method="post" name="ren_form" id="ren_form" action="{$action_url}">
	...
	<fieldset>
		<legend><span>{t}Change name{/t}</span></legend>
		<ol>
			<li>
    ...
    {if $is_section}
				<fieldset>
					<legend><span>{t}Language{/t}</span></legend>
					<ol>
	...
	<fieldset class="buttons-form">
				...
				{button label="Modify" class='validate' }<!--message="Are you sure you want to change the name?"-->
