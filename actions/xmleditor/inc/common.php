...
<!--
  for ( elem in window.dialogArguments )
  {
    ...
    case "url":
		...
		my_location = "../treeselector.php?contenttype=common&targetid=" + ID_imagen;
...
<script LANGUAGE="Javascript">
document.write('<IFRAME application="yes" ID="appletdiv" style="position:absolute;left:10px;top:27px;width:302px;height:308px;visibility:show" NAME="treeFrame" WIDTH=302 HEIGHT=308 SRC="../treeselector.php?contenttype=common&targetid=' + targetid + '"></IFRAME>');
</script>
