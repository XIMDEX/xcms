...
// FUNCIÓN DE limpieza de nodos
function limpia_HTML()
  {
      ...
      {
        found = false;
        var els = tbContentElement.DOM.body.all;
        for (var i=0; i<els.length; i++)
        {
          ...
          // borramos las etiquetas font, span y div
      ...
      // borramos los estilos de todas las etiquetas
      var els = tbContentElement.DOM.body.all;
      for (var i=0; i<els.length; i++)
      {
