    ...
    */
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function() {
            ...
            //add a class for get the checkboxes 
            container.addClass(this.options.selector);
            container.addClass("ui-dropdownchecklist-dropcontainer")
                .css("overflow-y", "auto");
            wrapper.append(container);
            
            if (this.options.actions){
     			$(this.options.listActions).each(function( id, item ){
     				
     				 actionContainer = $("<div/>");
                     actionContainer.addClass("ui-dropdownchecklist-action");
                     
                     if (item.href){
                    	 action = '<div>'+item.link+'</div>';
                     }else{
                    	 action = '<div ><a href="javascript:'+item.method+'">'+item.label+'</a></div>';
                     }
