 ...
 */
require_once XIMDEX_ROOT_PATH . '/extensions/phpseclib0.1.5/PHP/Compat/Function/bcpowmod.php';
/**
 * Include PHP_Compat module array_fill since that function requires PHP4.2.0+:
 * {@link http://pear.php.net/package/PHP_Compat/}
 * {@link http://php.net/function.array_fill}
 */
require_once XIMDEX_ROOT_PATH . '/extensions/phpseclib0.1.5/PHP/Compat/Function/array_fill.php';
        ...
        for ($i = 0; $i < $e_length; ) {
            if ( !$e_bits[$i] ) {
                ...
                for ($j = $window_size - 1; $j >= 0; $j--) {
                    if(isset($e_bits[$i + $j] ) && $e_bits[$i + $j]) {
                        break;
                    }
                }
