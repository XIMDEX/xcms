...
class GraphSerieValues_ORM extends GenericData   {
	var $_idField = 'id';
	var $_table = 'GraphSerieValues';
	var $_metaData = array(
				'id' => array('type' => "int(11)", 'not_null' => 'true', 'auto_increment' => 'true', 'primary_key' => true),
				'IdGraphSerie' => array('type' => "int(11)", 'not_null' => 'true'),
				'x' => array('type' => "double", 'not_null' => 'false'),
				'y' => array('type' => "double", 'not_null' => 'false'),
				'TimeStamp' => array('type' => "timestamp", 'not_null' => 'false')
				);
