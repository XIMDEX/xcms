 ...
 * @version $Revision$
 */
class NodeNameTranslations_ORM extends \Ximdex\Data\GenericData
{
    var $_idField = 'IdRel';
    var $_table = 'NodeNameTranslations';
    var $_metaData = array(
        'IdRel' => array('type' => "int(12)", 'not_null' => 'true', 'auto_increment' => 'true', 'primary_key' => true),
        'IdNode' => array('type' => "int(12)", 'not_null' => 'true'),
        'IdLanguage' => array('type' => "int(12)", 'not_null' => 'true'),
        'Name' => array('type' => "varchar(255)", 'not_null' => 'false')
    );
    var $_uniqueConstraints = array(
        'NodeLanguage' => array('IdNode', 'IdLanguage')
    );
