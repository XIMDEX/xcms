...
class NodeRelations_ORM extends GenericData   {
	var $_idField = 'IdRel';
	var $_table = 'NodeRelations';
	var $_metaData = array(
				...
				'IdNodeRelation' => array('type' => "int(12)", 'not_null' => 'true'),
				'version' => array('type' => "tinyint(3)", 'not_null' => 'false')
				);
