...
class RelXimletNode_ORM extends GenericData   {
	var $_idField = 'IdRel';
	var $_table = 'RelXimletNode';
	var $_metaData = array(
				'IdRel' => array('type' => "int(12)", 'not_null' => 'true', 'auto_increment' => 'true', 'primary_key' => true),
				'IdXimLetNode' => array('type' => "int(12)", 'not_null' => 'true'),
				'IdSectionNode' => array('type' => "int(12)", 'not_null' => 'true')
				);
