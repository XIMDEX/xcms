 ...
 * a traves del socket, pero se bloquean todas las se�ales enviadas al proceso y no
 * se pueden gestionar.
 *
 * En el segundo caso las se�ales son gestionadas sin problemas, pero el bucle en handle()
 * hace que la CPU se dispare al 100%.
 *
 * La solucion es abrir el socket en modo bloqueante y usar la funcion socket_select(), esta
 * bloquea el proceso pero da la posibilidad de establecer un timeout. De esta forma las se�ales
