...
// //	}
	...
	public function load () {
		...
		/* Esto es un barrido de los arrays por tags para a�adir en children sus respetivos hijos ( s�lo se a�aden los hijos de UN nivel por debajo ).*/
	...
	//Se encarga b�sicamente de crear un array por cada tag, tambi�n por id.
	//As� tendremos arrays como: link, image,,... que contiene a todos los enlaces e im�genes respectivamente.
    ...
    protected function _tag_data($parser, $cdata) {
		...
		$j = count($this->elements[$tag]);
		$j--; //Contamos uno menos, porque se est� a�adiendo el mismo
