...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6100,5032,'Publish advance','workflow_forward_advance','change_next_state.png','Advance publish',70,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6145,5041,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6146,5028,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6148,5039,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6150,5057,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6143,5032,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6231,5076,'Version manager','manageversions','manage_html_versions.png','Manage repository of versions',73,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)          VALUES (8119,5077,'Version manager','manageversions','manage_versions.png','Manage repository of versions',73,NULL,0,'');
