...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6011,5012,'Add new project','addfoldernode','create_proyect.png','Create a new node with project type',11,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6037,5017,'Delete folder','deletenode','delete_folder_images.png','Delete selected folder',51,NULL,1,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6039,5021,'Delete folder','deletenode','delete_folder_import.png','Delete selected folder',51,NULL,1,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6040,5023,'Delete folder','deletenode','delete_folder_common.png','Delete selected folder',51,NULL,1,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6041,5025,'Delete folder','deletenode','delete_folder_css.png','Delete selected folder',51,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6088,5039,'Delete','deletenode','delete_file_txt_bin.png','Delete file of import folder',51,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6106,5028,'Delete','deletenode','delete_file_css.png','Delete file of import folder',51,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6119,5048,'Delete folder','deletenode','delete_link_folder.png','Delete selected folder',51,NULL,1,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6141,5055,'Delete folder','deletenode','delete_folder_ximlet.png','Delete selected folder',51,NULL,1,'');
