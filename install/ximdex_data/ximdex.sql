...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`, `IsBulk`)  VALUES (8115,5053,'Add schemes', 'fileupload_common_multiple', 'add_template_pvd.png', 'Add a set of schemes to the server', 11, NULL, 0, 'type=pvd', 0);
...
-- EDIT
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`,`Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)       VALUES (6136,5032,'Edit in text mode','edittext','edit_file_xml_txt.png','Edit content of structured document in plain text',20,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`,`Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)       VALUES (6157,5057,'Edit in text mode','edittext','edit_file_xml_txt.png','Edit ximlet with text mode',20,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`,`Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`, `IsBulk`)   VALUES (6209,5085,'Edit metadata in text mode', 'edittext', 'edit_file_xml_txt.png', 'Edit metadata content in text plain mode', 20, NULL, 0, '', 0);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`,`Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)       VALUES (6227,5076,'Edit in text mode','edittext','edit_html_txt_file.png','Edit content of text document',20,NULL,0,'');
...
-- DELETE
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6003,5009,'Remove user','deleteuser','delete_user.png','Remove an user from system',50,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6135,5032,'Symbolic link','xmlsetlink','file_xml_symbolic.png','Modify document which borrows the content',60,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6156,5057,'Symbolic link','xmlsetlink','file_xml_symbolic.png','Modify the ximlet which borrows the content',60,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6007,5015,'Configure section','managefolders','change_name_section.png','Configure the folders of a section',60,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6028,5017,'Change name','renamenode','change_name_folder_images.png','Change name of selected folder',60,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6030,5021,'Change name','renamenode','change_name_folder_import.png','Change name of selected folder',60,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6031,5023,'Change name','renamenode','change_name_folder_common.png','Change name of selected folder',60,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6032,5025,'Change name','renamenode','change_name_folder_css.png','Change folder name',60,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6103,5028,'Change name','renamenode','change_name_file_css.png','Change file name on import folder',60,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6087,5039,'Change name','renamenode','change_name_file_txt_bin.png','Change file name on import folder',60,NULL,0,'');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6118,5048,'Change name','renamenode','modify_link_folder.png','Change name of selected folder',60,NULL,0,'');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`, `Params`)        VALUES (6142,5055,'Change name','renamenode','change_name_folder_ximlet.png','Change folder name',60,NULL,0,'');
