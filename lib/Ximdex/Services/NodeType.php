...
class NodeType
{
    ...
    const XIMNEWS_SECTION = 5300;
    const XIMNEWS_BULLETIN_LANGUAGE_XIMLET = 5312;
    const XIMNEWS_NEW_LANGUAGE = 5309;
    const XIMNEWS_BULLETIN_LANGUAGE = 5308;
    const XIMNEWS_NEWS = 5304;
    const XIMNEWS_BULLETINS = 5301;
    const XIMNEWS_IMAGES = 5306;
}