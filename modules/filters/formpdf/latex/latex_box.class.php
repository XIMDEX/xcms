...
class Latex_box extends Latex {
	...
	function setBorderRound($value) {
		$this->borderRound = $value;
	}
	function add_box() {
		//default values
/*
		...
		if (!empty ($this->borderWidth)) {
			...
			$this->x += $correct;
			$this->y += $correct;*/
			if ($this->borderWidth > 0) $borderColor = 'border';
		}

		// latex code to show the box(caja)
		$resultado .= "\\caja{".$this->x."}{".$this->y."}{".$this->width."}{".$this->height."}{".$this->borderWidth."}{".$this->borderRound."}{".$borderColor."}\n";
