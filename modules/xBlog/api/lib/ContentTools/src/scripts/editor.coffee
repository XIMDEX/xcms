class _EditorApp extends ContentTools.ComponentUI
    ...
    publish: (passive, args...) ->
        ...
        # Trigger the publish event with a region HTML map for the changed
        # content.
        @trigger('publish', modifiedRegions, args...)
