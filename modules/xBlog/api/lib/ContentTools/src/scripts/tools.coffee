...
class ContentTools.Tools.Heading extends ContentTools.Tool
    ...
    @canApply: (element, selection) ->
        ...
        return element.content != undefined and
                element.parent().type() is 'Region' and element.type() != 'Intro'
...
class ContentTools.Tools.Paragraph extends ContentTools.Tools.Heading
    ...
    @canApply: (element, selection) ->
        # Return true if the tool can be applied to the current
        # element/selection.
        return element != undefined and element.type() != 'Intro'
...
class ContentTools.Tools.AlignLeft extends ContentTools.Tool
    ...
    @icon = 'align-left'
    @className = 'text-left'
    @imageClassName = 'pull-left'

    @canApply: (element, selection) ->
        # Return true if the tool can be applied to the current
        # element/selection.
        return element.type() == 'Image' or (element.content != undefined and element.type() != 'Intro')
    ...
    @isApplied: (element, selection) ->
        ...
        if element.type() is 'Image'
            return element.hasCSSClass(@imageClassName)
    ...
    @apply: (element, selection, callback) ->
        ...
        for className in ['text-center', 'text-left', 'text-right', 'pull-left', 'pull-right']
            if element.hasCSSClass(className)
                element.removeCSSClass(className)
        ...
        if element.type() is 'Image'
            element.addCSSClass(@imageClassName)
        else
            element.addCSSClass(@className)
...
class ContentTools.Tools.AlignCenter extends ContentTools.Tools.AlignLeft
    ...
    @isApplied: (element, selection) ->
        ...
        if element.type() is 'Image'
            return !element.hasCSSClass('pull-left') and !element.hasCSSClass('pull-right')
...
class ContentTools.Tools.UnorderedList extends ContentTools.Tool
    ...
    @canApply: (element, selection) ->
        ...
        # element/selection.
        return element.content != undefined and
                element.parent().type() in ['Region', 'ListItem'] and element.type() != 'Intro'
...
class ContentTools.Tools.Indent extends ContentTools.Tool
    ...
    @canApply: (element, selection) ->
        ...
        return element.parent().type() is 'ListItem' and
                element.parent().parent().children.indexOf(element.parent()) > 0  and element.type() != 'Intro'
...
class ContentTools.Tools.Unindent extends ContentTools.Tool
    ...
    @canApply: (element, selection) ->
        # Return true if the tool can be applied to the current
        # element/selection.
        return element.parent().type() is 'ListItem' and element.type() != 'Intro'
...
class ContentTools.Tools.LineBreak extends ContentTools.Tool
    ...
    @canApply: (element, selection) ->
        # Return true if the tool can be applied to the current
        # element/selection.
        return element.content and element.type() != 'Intro'
