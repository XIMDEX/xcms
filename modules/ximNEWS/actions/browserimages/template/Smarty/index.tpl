...
<p>{t}Select the way you want to explore the image batch:{/t}<span id="typeView"><input type="radio" name="grupoforma" value="lista" onclick="changeViewR(this);" checked />{t}List{/t}<input type="radio" name="grupoforma" value="miniaturas" onclick="changeViewR(this);" />{t}Miniatures{/t}</span></p>
<br/>
