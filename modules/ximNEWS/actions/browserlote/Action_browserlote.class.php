...
class Action_browserlote extends ActionAbstract {
   // Main method: shows the init form
    function index () {
	//Old way to do it. It should be migrated to new template
	//include_once (XIMDEX_ROOT_PATH."/modules/ximNEWS/actions/browserlote/init.php");
