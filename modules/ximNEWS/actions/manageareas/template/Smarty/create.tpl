...
<form method="post" name="ca_form" id="ca_form"  action="{$action_url}">
	<fieldset>
		...
		<legend><span>{t}Create category{/t}</span></legend>
		<ol>
			<li>
				<label class="aligned">{t}Name{/t}</label>
				<input type="text" name="area_name" value="" class="cajag validable not_empty"/>
			</li>
			<li>
				<label class="aligned">{t}Description{/t}</label>
				<input type="text" name="area_description" value="" class="cajag validable not_empty"/>
			</li>
		</ol>
	</fieldset>
