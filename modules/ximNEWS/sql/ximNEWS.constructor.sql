...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`) 	VALUES (6720,5306,'Add image batch','createLote','add_folder_images.png','Create a new image folder',11,'ximNEWS',0);
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Params`) 	VALUES (6726,5310,'Add image','fileupload','upload_image.png','Add a new image to the folder',11,'','type=ximnewsimage');
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Params`) 	VALUES (6727,5310,'Add images','fileupload_common_multiple','upload_image.png','Add a set of images to the folder',11,NULL,'type=ximnewsimage');
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`) 	VALUES (7020,5300,'Add news folder','addfoldernode','xix.png','Create a new news folder',11,NULL,0);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`) VALUES (6725,5310,'Delete folder','deletenode','delete_folder_images.png','Delete the selected folder',51,'',1);
...
-- MODIFY
INSERT INTO `Actions` (`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`, `Sort`, `Module`, `Multiple`, `Params`) VALUES (7313, 5300, 'Modify heritable properties', 'manageproperties', 'xix.png', 'Modify the ximNEWS folder properties', 61, NULL, 0, NULL);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`) VALUES (6724,5310,'Change name','renamenode','change_name_folder_images.png','Change the name of the selected folder',61,'',0);
...
INSERT INTO `Actions`(`IdAction`, `IdNodeType`, `Name`, `Command`, `Icon`, `Description`,`Sort`, `Module`, `Multiple`) VALUES (6712,5300,'Associate ximlet with ximNEWS section','addximlet','asociate_ximlet_folder.png','Associate a ximlet to the section',61,NULL,1);
