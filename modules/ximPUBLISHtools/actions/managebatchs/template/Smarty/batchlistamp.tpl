	...
	<tr>
		<td class="filacerrar" align="right">
			<a href="javascript:parent.deletetabpage(parent.selected);" class="filacerrar">
				{t}Close window{/t} <img src="{url}/assets/images/botones/cerrar.gif{/url}" alt="" border="0">
			</a>
		</td>
	</tr>
				...
				<tr>
					<td align="right" colspan="3" class=cabeceratabla>
						{if $hasBatchs eq 'true'}
							...
							<option value="">{t}Any generator node{/t}...</option>
		...
		<td align="center" class="filaclara"><br>
			<table align=center class=tabla width=500 cellpadding="0" cellspacing="1">
				<tr>
					<td class=cabeceratabla>
						...
						&nbsp;&nbsp;&nbsp;
						[<a href="#" onClick="javascript: showOrHideContent('batch{$batch.IdBatch}');">Ver Frames</a>]
					</td>
					<td class=cabeceratabla>
						{t}Date:{/t}
						&nbsp;
			...
			<table align=center class=tabla width=500 cellpadding="0" cellspacing="1">
				<tr>
					...
					<td class=cabeceratabla>{t}Status{t}</td>
				...
				<tr>
					...
					<td align="center" class="filaoscura">
						{if $batch.Playing eq 1}
							<input type="button" name="frm_deactivate_batch_button" value="Pausar" 
							...
							<table align=center class=tabla width=98% cellpadding="0" cellspacing="1">
								<tr>
									<td colspan="6" class="filaoscura">
										<strong>Sub-Lote #{$batch.IdBatch}.{$iSubBatch}</strong></td>
								</tr>
								<tr>
									<td class="filaoscura">{t}Fichero{t}</td>
									<td class="filaoscura">{t}Tama&ntilde;o{t}(Kb.)</td>
									<td class="filaoscura">{t}Publicaci&oacute;n{t}</td>
									<td class="filaoscura">{t}Despublicaci&oacute;n{t}</td>
									<td class="filaoscura">{t}Estado{t}</td>
									<td class="filaoscura">{t}Ver{t}</td>
								</tr>
				...
				<tr>
					<td colspan="6" class="filaclara">
						...
						<table align=center class=tabla width=98% cellpadding="0" cellspacing="1">
							...
							<tr>
								<td class="filaoscura">Sub-Lote</td>
								<td class="filaoscura">Ficheros</td>
								<td class="filaoscura">Total (Kb.)</td>
								<td class="filaoscura">Avg. (Kb.)</td>
							...
							{foreach from=$batch.progress key=subBatch item=progress}
								...
								<tr>
									<td class="filaoscura">
										<strong>Sub-Lote #{$batch.IdBatch}.{$iSubBatch}</strong>
									</td>
									<td class="filaclara">
										{$progress.totalBatch}
									</td>
