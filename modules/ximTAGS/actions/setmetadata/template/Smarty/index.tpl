    ...
    <div class="action_content">
        <div class="xim-tagsinput-container-list">
            <div class="xim-tagsinput-newtag  col2-3">
                ...
                <input type="text" class="xim-tagsinput-input" id="tag_input"
                       placeholder="{t}Create new tags here{/t}..." ng-model="newTag.Name"
                       ng-class="{literal}{error: tagExistInArray(newTag, documentTags)}{/literal}"
                       ng-keyup="keyPress($event)"/>
                <button type="button" class="btn-unlabel-rounded icon add-btn" ng-click="addNewTag()"
