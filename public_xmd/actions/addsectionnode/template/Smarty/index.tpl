        ...
        <div class="row tarjeta">
        	...
        	<div class="folder-name folder-normal icon input-select">
            	<div class="small-6 columns">
            		...
            		<input type="text" name="name" maxlength="100" ng-required="true" 
            				class="input_general_icon cajaxg full-size js_val_unique_name js_val_alphanumeric validable not_empty" 
            				placeholder="{t}Name of your section{/t}" data-idnode="{( isset($nodeID) ) ? $nodeID : '' }" />
            	</div>
            	<div class="small-6 columns">
            		<label  class="label_title label_general">{t}Type{/t} *</label>
                	<select ng-model="sectionTypeSelected" ng-options="stype.label for stype in sectionTypeOptions track by stype.value" 
                			ng-change="changeSubfolders()" name="nodetype" class="caja folder-type"></select>
            	</div>
            </div>
            ...
            <div class="languages-available small-4 columns">
                ...
                <div class="language-section" ng-repeat="lang in languageOptions">
                    ...
                    <input type="text" placeholder="{t}Alternative name for paths &amp; breadcrumbs{/t}" class="alternative-name" 
                    		name="namelst[#/lang.Id/#]">
                </div>
            </div>
