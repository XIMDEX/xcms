    ...
    <div class="action_content delete_node_content">
        <div class="row tarjeta">
            ...
            {if ($pendingTasks)}
                <div class="small-12 columns">
                    <div class="alert alert-info">
                        <p>
                            <strong>Info!</strong> 
                            {t}This node or its children have pending task to publish, if you continue these tasks will be interrupted{/t}!
                        </p>
                    </div>
                </div>
            {/if}
            ...
            {if ($isPublished)}
                <div class="small-12 columns">
                    <div class="alert alert-info">
                        <strong>Info!</strong> {t}This node, or one or more of its children, are published{/t}!.
                        {t}If you do not want to keep your nodes published{/t}:
                        <ul>
