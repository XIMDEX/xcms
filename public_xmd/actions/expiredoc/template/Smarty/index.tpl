...
<form method="post" name="expiredoc" action="{$action_url}">
						...
						<div class="publication_options">
						    <div class="publication_option">
                                ...
                                <div class="option_info">
                                    <label for="zero">{t}Expire only the current file.{/t}</label>
                                </div>
							...
							<div class="publication_option">
								...
								<div class="option_info">
									<label for="all_levels">{t}Expire all linked files.{/t}</label>
								</div>
								<div class="options_separator"></div>
							</div>
							<div class="publication_option">
							...
							{if $advanced_publication eq '1'}
								...
								<div class="publication_option disabled" id="no_structure_option" disabled="disabled">
									<div class="option_checkbox">
										<input type="checkbox" name="no_structure" id="no_structure" value="1" checked="checked" />
									</div>
									<div class="option_info">
