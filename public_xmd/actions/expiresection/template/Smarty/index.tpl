	...
	<div class="action_content" style="height: 82%;">
		<fieldset class="publish_date">
			<div class="xim_calendar_container">
				...
				<div class="row tarjeta propertyform">
				   <h2 class="h2_general">{t}Expiration options{/t}</h2>   
				   <div class="publication_options">
					    <div class="publication_option">
                               ...
                               <div class="option_info">
                                   <label for="zero">{t}Expire just{/t} <strong>{$node_name}</strong>.</label>
                               </div>
						...
						<div class="publication_option">
							...
							<div class="option_info">
								<label for="all_levels">{t}Expire{/t} <strong>{$node_name}</strong> {t}and its subsections{/t}.</label>
							</div>
							<div class="options_separator"></div>
						</div>
						<div class="publication_option">
							...
							<div class="option_info">
								<label for="deep_levels" >{t}Expire until a certain depth level{/t}:</label>
						...
						<!--
						<div class="publication_option disabled" id="last_edited_option">
							<div class="option_checkbox">
						...
						{if (!isset($globalForcedEnabled))}
							<div class="publication_option disabled">
								<div class="option_checkbox">
									<input type="checkbox" name="force" id="force" value="1" />
								</div>
								<div class="option_info">
									<label for="force">{t}Force expiration.{/t}</label>
								</div>
								<div class="options_separator"></div>
							</div>
						{/if}
						...
						{if $synchronizer_to_use eq 'ximSYNC' and $ximpublish_tools_enabled and isset($publishabledtypes)}
						    <div class="publication_option">
                                ...
                                <div class="option_info">
                                    <label for="publishType">{t}Node type to expire{/t}:</label>&nbsp;
		...
		<div class="small-12 columns">
			<fieldset class="buttons-form">
                {button class="validate publicate-button btn main_action" label="Expire"}
			</fieldset>
		</div>
	</div>
</form>