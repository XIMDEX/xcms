...
<div ng-if="frames.stopped > 0" class="{$progress_bar_class} progress-bar progress-bar-striped progress-bar-stopped" 
...
<div ng-if="frames.soft > 0" class="{$progress_bar_class} progress-bar progress-bar-striped progress-bar-errored-soft" 
...
<div ng-if="frames.delayed > 0" class="{$progress_bar_class} progress-bar progress-bar-striped progress-bar-delayed" 
...
<div ng-if="frames.active > 0" class="{$progress_bar_class} progress-bar progress-bar-striped progress-bar-active active" role="progressbar" 
        style="width: #/ frames.active * 100 / frames.total | number:6 /#%;" title="#/ frames.active /# documents active">
    #/ frames.active /# active
</div>
<div ng-if="frames.pending > 0" class="{$progress_bar_class} progress-bar progress-bar-striped progress-bar-pending active" 
