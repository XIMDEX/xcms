...
<div class="action_header">
	...
	<fieldset class="action-controls">
		...
		{/if}
		<a id="prevdoc-button" href="{$_URL_ROOT}/public_xmd/?action=prevdoc&nodeid={$id_node}"
...
<div class="content_container prevdoc">
	<iframe id="preview{$id_node}" src="{$_URL_ROOT}/public_xmd/?action=prevdoc&nodeid={$id_node}&channel=10001" height="100%" width="100%">
