	...
	<form  method="post" name="formulario" id="formulario" action='{$action_url}'>
	    <div class="action_header">
	        ...
	        <fieldset class="buttons-form">
		        {button class="validate start_publication btn main_action" label="Accept" 
                        message="Would you like to continue with publication?"}
	        </fieldset>
		</div>
...
{/if}
{* <div id="publicando" style="display: none;"><img src="{url}/assets/images/indicator.gif{/url}" alt="" border="0" id="publicando"/></div> *}