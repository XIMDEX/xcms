        ...
        <div class="row tarjeta">
            ...
            <div class="small-8 columns">
                <div class="alert alert-info">
                    <strong>{t}Info:{/t}</strong> 
                    {t}the * value means any extension, empty value means none extension. You can't put ambiguous values.{/t}
                </div>
            </div>
            <div class="small-4 columns">
                <fieldset ng-init="label='{t}Save changes{/t}'; loading=false;" class="buttons-form">
                    <button class="btn main_action ui-state-default ui-corner-all button submit-button ladda-button btn_margin"
                            xim-button xim-loading="loading" xim-label="label" xim-progress="" xim-disabled="" 
