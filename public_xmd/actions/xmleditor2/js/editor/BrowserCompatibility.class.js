...
_create_minusButton: function(xsldoc) {
	...
	minusButton.setAttribute('src', url_root + '/assets/images/tree/Lminus.png');
...
_create_folderIcon: function(xsldoc) {
	...
	folderIcon.setAttribute('src', url_root + '/assets/images/tree/openfolder.png');
...
_create_blankImage: function(xsldoc) {
	...
	blankImage.setAttribute('src', url_root + '/assets/images/tree/blank.png');
