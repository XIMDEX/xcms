...
<div id="kupu-ximimagedrawer" class="kupu-drawer kupu-ximlinkdrawer-window xedit-toolbox ximlink_manager ximimage_manager">
	<div class="title_panel">
		<h3 i18n:translate="">{t}Image attributes{/t}</h3>
	</div>

	<div class="kupu-panels js_search_link_panel search_panel">
		<!-- <div class="search_links">
			<label for="ximlink-search" i18n:translate="" class="title">{t}Search existing images{/t}</label>
			<input id="ximlink-search" class="kupu-toolbox-st ximlink-search xlinks_input" type="text" />
		</div> -->

		<div id="attributes-list-options" class="attributes-list-options"></div>
	</div>
