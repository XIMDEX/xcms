...
angular.module('ximdex.common.directive').factory('TreeAssocNodes', ['$filter', function ($filter) {
    var scope = null;
    var root = null;

    var TreeAssocNodes = React.createClass({
        displayName: 'TreeAssocNodes',
        ...
        componentDidMount: function componentDidMount() {
            ...
            this.divRootHammer.on('doubletap', function (ev) {
        ...
        render: function render() {
            ...
            if (this.props.node.showNodes && this.props.node.collection != null) {
                ...
                childNodes = this.props.node.collection.map(function (node, index) {
                    return React.createElement("li", { key: index }, React.createElement(TreeAssocNodes, { node: node, selected: that.props.selected }));
                });
            }

            if (this.props.node.showNodes && this.props.node.loading) {
                loading = React.createElement('ul', { className: 'xim-treeview-loading' }, React.createElement('img', { src: window.com.ximdex.baseUrl + 'assets/images/browser/hbox/loading.gif' }));
            }
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: rootClasses, ref: 'divRoot' },
                    React.createElement('span', { ref: 'spanTriangle', className: dropDownClasses }),
                    React.createElement('span', { className: iconClasses, ref: 'icon' }),
    ...
    return TreeAssocNodes;
}]);

angular.module('ximdex.common.directive').directive('treeAssocNodes', ['reactDirective', function (reactDirective) {
    return reactDirective('TreeAssocNodes');
}]);
