	 ...
	 _init: function(options) {
		...
		this.inactivityDialog = new X.dialogs.MessageDialog({
								...
								onclose: function(event,params) {
									window.location.href = url_root + '/public_xmd/?action=logout';
								}.bind(this),
								...
								buttons: [{text: 'Login', value: 6, onPress: function() {window.location.href= url_root + '/public_xmd/?action=logout'; this.close();} }]
							});
		...
		setInterval(function() {
					...
					jQuery.ajax({ url: url_root + '/public_xmd/?action=browser3&method=refreshSession',
