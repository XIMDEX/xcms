...
<html>
    ...
    <body ng-app="ximdexInstallerApp" ng-cloak>
        <div class="aside">
            ...
            <?php foreach ($this->steps as $index => $step) {
				...
				<li class='installer_step <?php echo $extraStyle; ?>'>
					<span class="installer_step-launcher icon"><?php echo $step["description"]; ?></span>
               	</li>
            <?php } ?>
            </ul>
            <ul class="social">
                ...
                <li class="icon_btn">
                    <a target="_blank" href="https://plus.google.com/+Ximdex/about" class="icon google_btn" 
                    	title="Cuenta Google+ de Ximdex"></a>
                </li>
                <li class="icon_btn">
                    <a target="_blank" href="https://www.facebook.com/Ximdex" class="icon facebook_btn" 
                    	title="Cuenta Facebook de Twitter"></a>
                </li>
            </ul>
            <div class="footer">
        ...
        <div class="content step-<?php echo $this->installManager->currentState; ?>">
            <?php include_once($includeTemplateStep); ?>
        </div>
    </body>
</html>