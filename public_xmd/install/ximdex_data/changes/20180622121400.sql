...
ALTER TABLE `ServerFrames` ADD FOREIGN KEY (`IdNodeFrame`) REFERENCES `NodeFrames`(`IdNodeFrame`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `ServerFrames` ADD FOREIGN KEY (`IdServer`) REFERENCES `Servers`(`IdServer`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `ServerFrames` ADD FOREIGN KEY (`PumperId`) REFERENCES `Pumpers`(`PumperId`) ON DELETE SET NULL ON UPDATE SET NULL;