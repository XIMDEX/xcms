...
ALTER TABLE `PortalFrames` ADD CONSTRAINT `PortalFrames_Users` FOREIGN KEY (`CreatedBy`) 
    REFERENCES `Users`(`IdUser`) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE `PortalFrames` ADD CONSTRAINT `PortalFrames_Nodes` FOREIGN KEY (`IdPortal`) 
