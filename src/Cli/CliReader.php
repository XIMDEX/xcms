...
class CliReader
{
     ...
     * @param null $abortOptions
     * @param null $abortMessage
     * @return bool|null|string
     */
    public static function alert($continueOptions, $continueMessage, $abortOptions = NULL, $abortMessage = NULL)
    {
    ...
    public static function getString($continueMessage, $hiddenInput = false)
    {
        $stdin = fopen('php://stdin', 'r');
        echo $continueMessage;
        if ($hiddenInput) {
