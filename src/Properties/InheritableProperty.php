...
abstract class InheritableProperty {
	...
	public function applyPropertyRecursively($values) {
	    ...
	    $children = FastTraverse::get_children($this->nodeId, ['node' => ['IdNodeType']], null
	        , array('IdNodeType' => array(NodeTypeConstants::SERVER, NodeTypeConstants::SECTION, NodeTypeConstants::XML_ROOT_FOLDER
